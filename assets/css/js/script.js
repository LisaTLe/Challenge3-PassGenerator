...
function generatePassword() {
  var confirmLength = window.prompt(
    "How Many Characters Would You Like Your Password To Be? Password must be at least 8 characters long."
  );
  ...
  var confirmSymbols = confirm(
    "Click OK if you would like symbols to be included in your password"
  );
  var confirmNumbers = confirm(
    "Click OK if you would like numbers to be included in your password"
  );
  var confirmLower = confirm(
    "Click OK if you would like lowercase letters to be included in your password"
  );
  var confirmUpper = confirm(
    "Click OK if you would like uppercase letters to be included in your password"
  );
  ...
  while (
    ...
    var confirmLower = confirm(
      "Click OK if you would like lowercase letters to be included in your passwords"
    );
    var confirmUpper = confirm(
      "Click OK if you would like uppercase letters to be included in your password"
    );
